...
export default function ItemList() {
  ...
  const toggleAll = () => {
    ...
    else { setSelected(new Set(MOCK_ITEMS.map(r => r.id))); }
  ...
  const toggleRow = (id: string) => {
    ...
    setSelected(next);
    setAllChecked(next.size === MOCK_ITEMS.length);
  };
    ...
    <div className="itl-page">
      ...
      <div className="itl-filter-bar">
        <div className="itl-filter-tags">
          ...
          <div className="itl-filter-tag itl-tag-with-input">
            <span className="itl-tag-label">Item Name</span><span className="itl-tag-op">≈</span>
          </div>
          <div className="itl-filter-tag itl-tag-active">
            <span className="itl-tag-label">Item Group</span>
          </div>
          <div className="itl-filter-tag">
            <span className="itl-tag-label">Variant Of</span>
          </div>
          <div className="itl-filter-active-count">
            ...
            Filters 1
            <button className="itl-tag-clear" onClick={() => {}}>×</button>
          </div>
        </div>
      ...
      <div className="itl-has-variants">
        <input
          type="checkbox"
          id="hasVariants"
          checked={hasVariants}
          onChange={(e) => setHasVariants(e.target.checked)}
          className="itl-checkbox"
        />
        ...
        <table className="itl-table">
          <thead>
            <tr>
              ...
              <th className="itl-th itl-th-right">
                <span className="itl-count-label">{MOCK_ITEMS.length} of {MOCK_ITEMS.length}</span>
            ...
            {MOCK_ITEMS.map((row) => (
              ...
              >
                ...
                <td className="itl-td itl-td-meta">
                  ...
                  <button className="itl-comment-btn" onClick={(e) => e.stopPropagation()}>
                  ...
                  <button className="itl-like-btn" onClick={(e) => e.stopPropagation()}>
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                    </svg>
                  </button>
